...
<<<<<<< HEAD
    <button class="btn btn-primary mb-1 tambah"><i class="fas fa-plus"></i> Tambah Supplier</button>
=======
...
<<<<<<< HEAD
                        <label for="pemasok" class="col-sm-3 col-form-label">Nama Supplier</label>
=======
